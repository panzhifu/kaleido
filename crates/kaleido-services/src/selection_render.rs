...
mod tests {
    ...
    fn test_tile_range_for_selection() {
        ...
        // Tile size is 128. The selection spans:
        //   cols: 10..110  -> tile col 0 only (0..128)
        //   rows: 20..220  -> tile rows 0 and 1 (0..128, 128..256)
    ...
    fn test_tile_range_multi_tile() {
        ...
        let range = tile_range_for_selection(&sel, 512, 512);
        // cols: 50..250 -> tile cols 0, 1 (0..128, 128..256)
        // rows: 50..350 -> tile rows 0, 1, 2 (0..128, 128..256, 256..384)
        assert_eq!(range, Some((0, 0, 2, 3)));
    }
...
// ---------------------------------------------------------------------------
// Helper trait for div_ceil on u32
// ---------------------------------------------------------------------------
